 ...
 */
package org.esupportail.commons.web.jsf.tags.config;
	...
	public void setScripts(final List<String> scripts) {
		...
		for (String script : scripts) {
			if (script.startsWith("http://")
					...
					|| script.startsWith(".")
					|| script.startsWith("/")) {
				stylesheetUrl = script;
			} else {
				stylesheetUrl = getMediaPath() + "/" + script;
			}
			tmp.add(stylesheetUrl);
		}
		this.scripts = tmp;
	}
	...
	public void setStylesheets(final List<String> stylesheets) {
		...
		for (String stylesheet : stylesheets) {
			if (stylesheet.startsWith("http://")
				...
				stylesheetUrl = getMediaPath() + "/" + stylesheet;
			}
			tmp.add(stylesheetUrl);
		}
		this.stylesheets = tmp;
	}
