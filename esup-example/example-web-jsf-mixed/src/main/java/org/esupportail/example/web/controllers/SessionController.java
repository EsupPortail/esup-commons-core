...
public class SessionController extends AbstractDomainAwareBean {
	...
	/**
	 * The print format for PDF.
	 */
	private String printFormat = "A4P";
	...
	/**
	 * @return an Url (with the good host, port and context...) for help page.
	 */
	public String getPrintHelpUrl() {
		FacesContext facesContext = FacesContext.getCurrentInstance();
		return facesContext.getExternalContext().getRequestContextPath()
				+ "/stylesheets/print/help.pdf.xhtml";
	}
	...
	/**
	 * @return display print format.
	 */
	public String getDisplayPrintFormat() {
		if (printFormat.equals("A4P")) {
			return BundleService.getString("PREFERENCES.PRINT.A4_PORTRAIT");
		}
		if (printFormat.equals("A4L")) {
			return BundleService.getString("PREFERENCES.PRINT.A4_LANDSCAPE");
		}
		if (printFormat.equals("LUSP")) {
			return BundleService.getString("PREFERENCES.PRINT.LUS_PORTRAIT");
		}
		return BundleService.getString("PREFERENCES.PRINT.LUS_LANDSCAPE");
	}
