...
<head>
  ...
  <title>Application Example - Erreur</title>
</head>
<body>
<style>
body {
...
<div class="errorHeader">Application Example - Une erreur est survenue</div>
...
<div class="errorFooter">Application Example - Rapport d'exception</div>
